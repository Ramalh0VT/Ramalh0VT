...
<p>I <b>LOVE</b> to program, especially when we talk about doing things such as games, and art. <br>But i also LOVE to program to make things such as websites, it's that thing, adaptability is also a key element to being happy, as you won't be rigid and will be able to enjoy every thing moment!!<br> Oh and i <b>R E A L L Y</b> like linux XD, especially arch based distros (manjaro user here)</p>
